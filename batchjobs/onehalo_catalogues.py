...
parser.add_argument('-C','--catalogue', type = str, default = 'full',  help = 'Select whether to create full, mass, radial or both catalogues. Both means mass and radial catalogues. Defaults to full.')
