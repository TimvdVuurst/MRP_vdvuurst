...
parser.add_argument('-M1','--lower_mass', type = np.float32, default = 2, help = 'Lower bound of the mass range in dex above 10^10 Msun. This is inclusive! Defaults to 12.')
parser.add_argument('-M2','--upper_mass', type = np.float32, default = 6, help = 'Upper bound of the mass range in dex above 10^10 Msun. This is exclusive! Defaults to 16.') #always EXCLUSIVE upper bound
